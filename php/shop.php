...
?>
        ...
        <div id="myCarouse5" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                    <img src="http://schneider-digital.awiosapps.in.ua/wp-content/themes/codeus/bb/img/slider2.png" alt="img">
                    <div class="container">
    ...
    <section class="sect-one">
        <div class="container">
            <p class="text-center col-sm-8 col-sm-offset-2">
                Как гласит статистика, приведенная журналом Forbes, ежедневно около 1.000.000 человек
                совершают покупки в интернете. Это хорошая перспектива для развития бизнеса в онлайн. Учитывая,
                что каждый год количество покупок динамически возрастает на 15%, игнорировать
                потенциал интернет-торговли просто нельзя.
            </p>
            <div class="row">
                <div class="col-md-offset-1 col-md-3 item-box">
                    <img src="http://schneider-digital.awiosapps.in.ua/wp-content/themes/codeus/bb/img/icon-1.png" alt="">
                    <p>Что заставляет пользователя
                        совершить покупку?</p>
                </div>
                ...
                <div class="col-md-3 item-box">
                    <img src="http://schneider-digital.awiosapps.in.ua/wp-content/themes/codeus/bb/img/icon-3.png" alt="">
                    <p>Какие факторы
                        на это влияют?</p>
                </div>
            </div>
            <div class="row">
                <p class="text-center col-sm-8 col-sm-offset-2">
                    Ответ на все эти вопросы заключается в грамотном UI/UX проектировании и дизайне
                    интерфейсов для сайтов в интернете. Эти 2 этапа являются ключевыми и именно на них мы тратим
                    около 60% времени от всего периода работы над проектом.
                </p>
            </div>
        </div>
        <div class="bottom-sect">
            <ul>
                <li><span>Задача №1:</span> сайт должен быть простым и понятным для рядового пользователя.</li>
                <li><span>Цель проекта:</span> заставить посетителя совершить оплачиваемое или неоплачиваемое действие.
                </li>
                <li><span>Итог:</span> высокие показатели ROI и KPI, быстрая окупаемость проекта и выход в прибыль.</li>
            </ul>
        </div>
    </section>
    <section class="sect-two">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-offset-2 col-md-3 item-box">
                    <div class="img-box"><img src="http://schneider-digital.awiosapps.in.ua/wp-content/themes/codeus/bb/img/icon-4.png" alt=""></div>
                    <h3>Аналитика</h3>
                    <p>Проводим исследования ниши рынка,
                        собираем данные о конкурентах,
                        анализируем перспективы бизнеса.</p>
                </div>
                <div class="col-md-3 col-md-offset-2 item-box">
                    <div class="img-box"><img src="http://schneider-digital.awiosapps.in.ua/wp-content/themes/codeus/bb/img/icon-5.png" alt=""></div>
                    <h3>Визуализация</h3>
            ...
            <div class="row">
                <div class="col-md-offset-2 col-md-3 item-box">
                    <div class="img-box"><img src="http://schneider-digital.awiosapps.in.ua/wp-content/themes/codeus/bb/img/icon-6.png" alt=""></div>
                ...
                <div class="col-md-3 col-md-offset-2 item-box">
                    <div class="img-box"><img src="http://schneider-digital.awiosapps.in.ua/wp-content/themes/codeus/bb/img/icon-7.png" alt=""></div>
                    <h3>Тестирование</h3>
...
<!--                            <img src="http://schneider-digital.awiosapps.in.ua/wp-content/themes/codeus/bb/img/img-test.png" alt="">-->
...
<!--                <div class="carousel-inner" role="listbox">-->
<!--                    <div class="item active">-->
<!--                        <img src="http://schneider-digital.awiosapps.in.ua/wp-content/themes/codeus/bb/img/img-partners.png" alt="">-->
<!--                    </div>-->
<!--                    <div class="item">-->
<!--                        <img src="http://schneider-digital.awiosapps.in.ua/wp-content/themes/codeus/bb/img/img-partners.png" alt="">-->
<!--                    </div>-->
